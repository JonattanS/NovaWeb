...
const ReporteAnexosPorVencerDolarMonLocalPage = () => {
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 flex items-center">
              ...
              Reporte Anexos Por Vencer por Dolar/Moneda Local
            </h1>
          </div>
          ...
          {resultados.length > 0 && (
            <div className="flex gap-2">
              <ExcelExporter
                data={resultados}
                filename={`analisis_anexos_Por Vencer_por_dolar_mon_CSV_${new Date().toISOString().split('T')[0]}`}
                sheetName="Anexos Por Vencer por Dolar/Moneda Local"
                format="csv"
              ...
              <ExcelExporter
                data={resultados}
                filename={`analisis_anexos_Por Vencer_por_dolar_mon_${new Date().toISOString().split('T')[0]}`}
                sheetName="Anexos Por Vencer por Dolar/Moneda Local"
                format="xlsx"
                onProgressChange={(progress) => setExportProgress(progress)}
                onGeneratingChange={(generating) => setIsExporting(generating)}
            ...
            <CardHeader className="bg-gradient-to-r from-[#F7722F] to-[#00264D] text-white rounded-t-lg">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xl flex items-center">
                  ...
                  Resultados del Reporte Anexos Por Vencer por Dolar/Moneda Local
                </CardTitle>
...
export default ReporteAnexosPorVencerDolarMonLocalPage;