...
const ConsultaBalanceComprobacionPage = () => {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `Consulta_Balance_Comprobacion${new Date().toISOString().split("T")[0]}.csv`
    a.click()
  }
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      const a = document.createElement("a")
      a.href = blobUrl
      a.download = `consulta_documentos_${new Date().toISOString().split("T")[0]}.pdf`
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 flex items-center">
              ...
              Consulta Balance de Comprobacion
            </h1>
          </div>
...
export default ConsultaBalanceComprobacionPage