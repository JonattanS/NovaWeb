...
const EstadoResultadosPorSucursalCentroPage = () => {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `Estado_Resultados_Por_Sucursal_Centro_${new Date().toISOString().split("T")[0]}.csv`
    a.click()
  }
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      pdf.text("Estado de Resultados por Sucursal y Centro", 20, 20)
      ...
      const a = document.createElement("a")
      a.href = blobUrl
      a.download = `estado_resultados_por_sucursal_centro_${new Date().toISOString().split("T")[0]}.pdf`
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 flex items-center">
              ...
              Estado de Resultados por Sucursal y Centro
            </h1>
          </div>
...
export default EstadoResultadosPorSucursalCentroPage