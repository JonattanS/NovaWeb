...
const EstadoResultadosPorSucursalPage = () => {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `Estado_Resultados_Por_Sucursal_${new Date().toISOString().split("T")[0]}.csv`
    a.click()
  }
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      pdf.text("Estado de Resultados por Sucursal", 20, 20)
      ...
      const a = document.createElement("a")
      a.href = blobUrl
      a.download = `estado_resultados_por_sucursal_${new Date().toISOString().split("T")[0]}.pdf`
...
export default EstadoResultadosPorSucursalPage