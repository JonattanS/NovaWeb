...
const LibroMayorBalancesPorSucursalPage = () => {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `libro_mayor_balances_sucursal_${new Date().toISOString().split("T")[0]}.csv`
    a.click()
  }
  ...
  const exportToPDF = () => {
    ...
    pdf.text("Libro Mayor y Balances por Sucursal", 20, 20)
    ...
    pdf.save(`libro_mayor_balances_sucursal_${new Date().toISOString().split("T")[0]}.pdf`)
  }
