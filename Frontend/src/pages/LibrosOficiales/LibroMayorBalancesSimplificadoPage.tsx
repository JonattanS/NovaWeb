...
const LibroMayorBalancesSimplificadoPage = () => {
  ...
  // Campos específicos para libro mayor y balances simplificado
  const camposLibroMayorSimplificado = ['cta_cod', 'cta_nom', 'cmp_cod', 'cmp_nom', 'doc_tot_deb', 'doc_tot_crd'];
  
  // Filtrar solo los campos necesarios para libro mayor simplificado
  const resultadoFiltrado = resultado.map(row => {
    const filteredRow: any = {};
    camposLibroMayorSimplificado.forEach(campo => {
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 flex items-center">
              ...
              Libro Mayor y Balances Simplificado
            </h1>
          </div>
          ...
          {resultado.length > 0 && (
            <div className="flex gap-2">
              <ExcelExporter
                ...
                filename={`Libro Mayor y Balances SimplificadoCVS_${new Date().toISOString().split("T")[0]}`}
                sheetName="Libro Mayor y Balances Simplificado"
                format="csv"
              ...
              <ExcelExporter
                data={resultadoFiltrado}
                filename={`Libro Mayor y Balances Simplificado_${new Date().toISOString().split("T")[0]}`}
                sheetName="Libro Mayor y Balances Simplificado"
                format="xlsx"
                onProgressChange={(progress) => setExportProgress(progress)}
                onGeneratingChange={(generating) => setIsExporting(generating)}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-center pt-4 border-t">
                    ...
                    >
                      ...
                      {loading ? "Consultando..." : "Consultar Libro Mayor Simplificado"}
                    </Button>
                  </div>
                </form>
              </CardContent>
            ...
            <CardHeader className="bg-gradient-to-r from-[#F7722F] to-[#00264D] text-white rounded-t-lg">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xl flex items-center">
                  ...
                  Resultados del Libro Mayor Simplificado
                </CardTitle>
...
export default LibroMayorBalancesSimplificadoPage;