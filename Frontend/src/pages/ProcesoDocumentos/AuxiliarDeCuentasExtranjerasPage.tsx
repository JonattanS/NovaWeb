...
const AuxiliarDeCuentasExtranjerasPage = () => {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `auxiliar_cuentas_extranjeras_${new Date().toISOString().split("T")[0]}.csv`
    a.click()
  }
  ...
  const exportToPDF = () => {
    ...
    pdf.text("Auxiliar de Cuentas Extranjeras", 20, 20)
    ...
    pdf.save(`auxiliar_cuentas_extranjeras_${new Date().toISOString().split("T")[0]}.pdf`)
  }
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 flex items-center">
              ...
              Auxiliar de Cuentas Extranjeras
            </h1>
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-center pt-4 border-t">
                    ...
                    >
                      ...
                      {loading ? "Consultando..." : "Consultar Auxiliar Extranjeras"}
                    </Button>
                  </div>
                </form>
              </CardContent>
            ...
            <CardHeader className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-lg">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xl flex items-center">
                  ...
                  Resultados del Auxiliar Extranjeras
                </CardTitle>
...
export default AuxiliarDeCuentasExtranjerasPage;