...
const AuxiliarDeCuentasPage = () => {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `auxiliar_cuentas_${new Date().toISOString().split("T")[0]}.csv`
    a.click()
  }
  ...
  const exportToPDF = () => {
    ...
    pdf.text("Auxiliar de Cuentas", 20, 20)
    ...
    pdf.save(`auxiliar_cuentas_${new Date().toISOString().split("T")[0]}.pdf`)
  }
