...
const DiarioPorDocumentosPage = () => {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `diario_documentos_${new Date().toISOString().split("T")[0]}.csv`
    a.click()
  }
  ...
  const exportToPDF = () => {
    ...
    pdf.text("Diario Por Documentos", 20, 20)
    ...
    pdf.save(`diario_documentos_${new Date().toISOString().split("T")[0]}.pdf`)
  }
              ...
              <CardContent className="pt-0">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid gap-6">
                    ...
                    {/* Rango de Clase Documentos */}
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                        <Hash className="h-4 w-4" />
                        <span>Rango de Clase Documentos</span>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <Input
                          name="clc_cod_ini"
                          placeholder="Clase Documento Inicial"
                          value={filtros.clc_cod_ini}
                          onChange={handleChange}
                          className="bg-white"
                        />
                        <Input
                          name="clc_cod_fin"
                          placeholder="Clase Documento Final"
                          value={filtros.clc_cod_fin}
                          onChange={handleChange}
                          className="bg-white"
                        />
                      </div>
                    ...
                    {/* Rango de No. Documentos */}
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                        <FileText className="h-4 w-4" />
                        <span>Rango de No. Documentos</span>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <Input
                          name="doc_num_ini"
                          placeholder="No. Doc Inicial"
                  ...
                  <div className="flex justify-center pt-4 border-t">
                    ...
                    >
                      ...
                      {loading ? "Consultando..." : "Consultar Diario"}
                    </Button>
                  </div>
                </form>
              </CardContent>
...
export default DiarioPorDocumentosPage;