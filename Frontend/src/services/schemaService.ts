...
const CON_HIS_COLUMNS: TableColumn[] = [
  ...
  { name: 'adm_ciaid', type: 'integer', description: 'Id asignado a la compañía.', isNumeric: true, isDate: false, isText: false },
  { name: 'suc_cod', type: 'varchar', description: 'Sucursal/Agencia.', isNumeric: false, isDate: false, isText: true },
  { name: 'clc_cod', type: 'varchar', description: 'Clase de Documento.', isNumeric: false, isDate: false, isText: true },
  { name: 'doc_num', type: 'numeric', description: 'Número del Documento.', isNumeric: true, isDate: false, isText: false },
  { name: 'doc_fec', type: 'date', description: 'Fecha del Documento.', isNumeric: false, isDate: true, isText: false },
  { name: 'doc_tot_deb', type: 'numeric', description: 'Total débitos del documento.', isNumeric: true, isDate: false, isText: false },
  { name: 'doc_tot_crd', type: 'numeric', description: 'Total créditos del documento.', isNumeric: true, isDate: false, isText: false },
